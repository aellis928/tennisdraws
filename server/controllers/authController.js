    ...
    register: function(req, res){
      ...
      new_user.save()
        .then(function success(user){
          ...
          res.send({
            token: token,
            user: {_id: user._id, email: user.email, logged_in: true, first_name: user.first_name, last_name: user.last_name, location: user.location, program: user.program, inTournament: user.inTournament }
          });
        })
